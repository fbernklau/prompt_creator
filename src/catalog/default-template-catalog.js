    ...
    Jahresplanung: {
      ...
      templates: {
        Semesterplanung: defineTemplate({
          ...
          description: 'Erstellt eine kompetenzorientierte Semesterplanung mit klarer Progression und realistischem Zeitbezug.',
          ...
          dynamicFields: [
            {
              ...
              type: 'select',
              required: true,
              options: ['Semester', 'Schuljahr', 'Quartal'],
              placeholder: 'Bitte waehlen...',
              helpText: 'Fuer welchen Zeitraum soll die Planung erstellt werden?',
            },
            {
              id: 'kompetenzziele',
              label: 'Kompetenzziele',
              type: 'textarea',
              required: true,
              placeholder: 'Nenne 3-6 beobachtbare Kompetenzen laut Lehrplan.',
              helpText: 'Formuliere konkrete Kompetenzen, die im Zeitraum aufgebaut werden sollen.',
            },
            {
              id: 'themenfokus',
              label: 'Themenfokus',
              type: 'textarea',
              placeholder: 'Optional: zentrale Themenbloeke oder Schwerpunkte',
              helpText: 'Optional: Welche Themen sollen im Zeitraum besonders im Fokus stehen?',
            },
            {
              id: 'pruefungsfenster',
              label: 'Pruefungsfenster',
              type: 'text',
              placeholder: 'z. B. KW 45 und KW 4',
              helpText: 'Optional: Wichtige Leistungsnachweise oder Pruefungsfenster.',
            },
            {
              id: 'reservewochen',
              label: 'Reservewochen einplanen',
              type: 'checkbox',
              helpText: 'Aktivieren, wenn Puffer fuer Ausfaelle und Wiederholung beruecksichtigt werden soll.',
            },
          ],
        }),
        Kompetenzraster: defineTemplate({
          ...
          description: 'Erstellt ein differenziertes Kompetenzraster mit klaren Kriterien und Niveaustufen.',
          profile: 'unterrichtsnah',
          requiredBaseFields: ['fach', 'schulstufe', 'ziel'],
          ...
          dynamicFields: [
            {
              id: 'kompetenzbereiche',
              label: 'Kompetenzbereiche',
              type: 'textarea',
              required: true,
              placeholder: 'z. B. Lesen, Schreiben, Argumentieren',
              helpText: 'Welche Kompetenzbereiche sollen im Raster abgebildet werden?',
            },
            {
              id: 'niveaustufen',
              label: 'Niveaustufen',
              type: 'multiselect',
              required: true,
              options: ['Basis', 'Mittel', 'Erweitert'],
              placeholder: 'Bitte waehlen...',
              helpText: 'Waehle alle Niveaustufen, die fuer deine Lerngruppe relevant sind.',
            },
            {
              id: 'bewertungsskala',
              label: 'Bewertungsskala',
              type: 'select',
              options: ['4-stufig', '5-stufig', 'Punkte'],
              placeholder: 'optional',
              helpText: 'Optional: Skala fuer transparente Rueckmeldung und Bewertung.',
            },
          ],
        }),
        Themenverteilung: defineTemplate({
          ...
          description: 'Verteilt Themen didaktisch sinnvoll ueber den Zeitraum und priorisiert Schwerpunkte.',
          profile: 'unterrichtsnah',
          requiredBaseFields: ['fach', 'schulstufe', 'ziel'],
          ...
          dynamicFields: [
            {
              ...
              type: 'textarea',
              required: true,
              placeholder: 'Thema 1, Thema 2, Thema 3 ...',
              helpText: 'Nenne die zentralen Themen in geplanter Reihenfolge.',
            },
            {
              id: 'sequenzlogik',
              label: 'Sequenzlogik',
              ...
              helpText: 'Wie sollen die Themen didaktisch aufeinander aufbauen?',
            },
            {
              id: 'wochenstunden',
              label: 'Wochenstunden',
              type: 'text',
              placeholder: 'z. B. 3 UE/Woche',
              helpText: 'Optional: durchschnittliche Unterrichtszeit pro Woche.',
            },
            {
              id: 'priorisierung',
              label: 'Priorisierung',
              ...
              placeholder: 'optional',
              helpText: 'Optional: markiere Themen nach Muss/Soll/Kann.',
            },
          ],
        }),
        'Pruefungs- und Leistungsfenster': defineTemplate({
          ...
          description: 'Plant Leistungsnachweise ueber den Zeitraum inklusive Gewichtung, Puffer und Nachhollogik.',
          profile: 'unterrichtsnah',
          requiredBaseFields: ['fach', 'schulstufe', 'ziel'],
          ...
          dynamicFields: [
            {
              ...
              type: 'multiselect',
              required: true,
              options: ['Test', 'Pruefung', 'Projekt', 'Praesentation', 'Mitarbeit'],
              placeholder: 'Bitte waehlen...',
              helpText: 'Welche Leistungsformate sollen eingeplant werden?',
            },
            {
              id: 'zeitraumfenster',
              label: 'Zeitraumfenster',
              type: 'text',
              required: true,
              placeholder: 'z. B. Okt-Jan',
              helpText: 'In welchem Zeitraum liegen die Leistungsfenster?',
            },
            {
              id: 'gewichtung',
              label: 'Gewichtung',
              type: 'textarea',
              placeholder: 'z. B. Test 30 %, Projekt 40 %, Mitarbeit 30 %',
              helpText: 'Optional: Verteilung der Bewertung ueber Leistungsarten.',
            },
            {
              id: 'nachholmoglichkeiten',
              label: 'Nachholmoglichkeiten einplanen',
              type: 'checkbox',
              helpText: 'Aktivieren, wenn alternative Termine/Formate mitgedacht werden sollen.',
            },
          ],
        }),
      },
    ...
    Unterrichtsvorbereitung: {
      ...
      templates: {
        Stundendesign: defineTemplate({
          ...
          description: 'Plant eine didaktisch strukturierte Unterrichtsstunde mit Lernziel, Ablauf und Sicherung.',
          profile: 'unterrichtsnah',
          requiredBaseFields: ['fach', 'schulstufe', 'ziel'],
          optionalBaseFields: ['zeitrahmen', 'niveau', 'rahmen', 'ergebnisformat', 'ton', 'rueckfragen'],
          ...
          dynamicFields: [
            {
              ...
              type: 'text',
              required: true,
              placeholder: 'Am Ende der Stunde koennen die Lernenden ...',
              helpText: 'Formuliere das Lernziel konkret und beobachtbar.',
            },
            {
              id: 'dauer',
              label: 'Dauer',
              type: 'select',
              required: true,
              options: ['45 Min', '50 Min', '90 Min', '100 Min'],
              placeholder: 'Bitte waehlen...',
              helpText: 'Gesamtdauer der geplanten Stunde.',
            },
            {
              id: 'sozialform',
              label: 'Sozialform',
              type: 'select',
              options: ['Einzelarbeit', 'Partnerarbeit', 'Gruppenarbeit', 'Plenum'],
              placeholder: 'optional',
              helpText: 'Optional: Hauptsozialform der zentralen Arbeitsphase.',
            },
            {
              id: 'sicherung_transfer',
              label: 'Sicherung/Transfer',
              type: 'textarea',
              placeholder: 'Optional: Wie wird gesichert und in neue Kontexte transferiert?',
              helpText: 'Optional: Plane den Abschluss mit Sicherung und Transfer.',
            },
          ],
        }),
        Unterrichtssequenz: defineTemplate({
          id: 'uv-unterrichtssequenz',
          categoryTitle: 'Unterrichtsvorbereitung',
          templateTitle: 'Unterrichtssequenz',
          description: 'Plant eine mehrstuendige Unterrichtssequenz zu einem Thema mit Lernprogression und Checkpoints.',
          profile: 'unterrichtsnah',
          requiredBaseFields: ['fach', 'schulstufe', 'ziel'],
          optionalBaseFields: ['zeitrahmen', 'niveau', 'rahmen', 'ergebnisformat', 'ton', 'rueckfragen'],
          tags: ['unterricht', 'planung', 'sequenz'],
          dynamicFields: [
            {
              id: 'sequenzthema',
              label: 'Sequenzthema',
              type: 'text',
              required: true,
              placeholder: 'z. B. Argumentieren in Sachtexten',
              helpText: 'Welches Kernthema steht im Mittelpunkt der Sequenz?',
            },
            {
              id: 'umfang_stunden',
              label: 'Umfang (Unterrichtseinheiten)',
              type: 'select',
              required: true,
              options: ['4 UE', '6 UE', '8 UE', '10 UE', '12 UE'],
              placeholder: 'Bitte waehlen...',
              helpText: 'Wie viele Unterrichtseinheiten umfasst die Sequenz?',
            },
            {
              id: 'kompetenzziele',
              label: 'Kompetenzziele',
              type: 'textarea',
              required: true,
              placeholder: 'Nenne 3-5 Kompetenzen, die aufgebaut werden sollen.',
              helpText: 'Welche Kompetenzen sollen die Lernenden am Ende erreichen?',
            },
            {
              id: 'phasenstruktur',
              label: 'Phasenstruktur',
              type: 'textarea',
              required: true,
              placeholder: 'z. B. Einstieg, Erarbeitung, Vertiefung, Sicherung',
              helpText: 'Skizziere die Sequenzphasen in didaktisch sinnvoller Reihenfolge.',
            },
            {
              id: 'leistungsnachweis',
              label: 'Leistungsnachweis',
              type: 'text',
              placeholder: 'Optional: geplanter Leistungsnachweis am Ende der Sequenz',
              helpText: 'Optional: Welche Form von Leistungsnachweis ist vorgesehen?',
            },
            {
              id: 'differenzierung',
              label: 'Differenzierung',
              type: 'textarea',
              placeholder: 'Optional: Anpassungen fuer unterschiedliche Lernniveaus',
              helpText: 'Optional: Wie wird auf heterogene Lernvoraussetzungen eingegangen?',
            },
            {
              id: 'materialhinweise',
              label: 'Materialhinweise',
              type: 'textarea',
              placeholder: 'Optional: Material, Medien, Tools',
              helpText: 'Optional: Nenne benoetigte Materialien oder digitale Werkzeuge.',
            },
          ],
        }),
        Arbeitsauftraege: defineTemplate({
          ...
          description: 'Erstellt differenzierte Arbeitsauftraege mit klaren Anforderungen und passendem Anspruchsniveau.',
          profile: 'unterrichtsnah',
          requiredBaseFields: ['fach', 'schulstufe', 'ziel'],
          optionalBaseFields: ['zeitrahmen', 'niveau', 'rahmen', 'ergebnisformat', 'ton'],
          ...
          dynamicFields: [
            {
              ...
              optionHelp: {
                'Übung': 'Festigt Grundlagen mit klaren, wiederholbaren Arbeitsschritten.',
                'Transfer': 'Überträgt Gelerntes auf neue Situationen oder Beispiele.',
                'Problemlösen': 'Lässt Lernende schrittweise eine offene Aufgabe lösen.',
                'Recherche': 'Fokussiert Informationssuche, Auswahl und Bewertung von Quellen.',
                'Kreativauftrag': 'Erzeugt ein eigenes Produkt (z. B. Text, Audio, Visualisierung).',
                'Analyse': 'Untersucht Material systematisch nach Merkmalen und Zusammenhängen.',
                'Argumentation': 'Begründet eine Position mit nachvollziehbaren Argumenten.',
                'Projektarbeit': 'Plant und strukturiert längere Arbeit mit Teilzielen.',
                'Präsentation': 'Bereitet Ergebnisse adressatengerecht und verständlich auf.',
                'Portfolio': 'Dokumentiert Lernprozess, Produkte und Reflexion über Zeit.',
              },
              placeholder: 'Bitte waehlen...',
              customPlaceholder: 'Eigener Aufgabentyp',
              helpText: 'Welche Art von Lernleistung soll der Auftrag einfordern?',
            },
            {
              id: 'differenzierungsziel',
              label: 'Differenzierungsziel',
              type: 'text',
              required: true,
              placeholder: 'z. B. Niveau A/B/C mit abgestuften Hilfen',
              helpText: 'Wie soll die Aufgabe an unterschiedliche Lernniveaus angepasst werden?',
            },
            {
              id: 'materialhinweise',
              label: 'Materialhinweise',
              type: 'text',
              placeholder: 'Optional: Buchseite, Tool, Arbeitsblatt, Medien',
              helpText: 'Optional: Relevante Materialien oder Hilfsmittel fuer die Bearbeitung.',
            },
          ],
        }),
        Materialerstellung: defineTemplate({
          ...
          description: 'Erstellt Unterrichtsmaterial im gewuenschten Format passend zu Lernziel und Thema.',
          profile: 'unterrichtsnah',
          requiredBaseFields: ['fach', 'schulstufe', 'ziel'],
          ...
          dynamicFields: [
            {
              id: 'materialformat',
              label: 'Materialformat',
              type: 'select',
              required: true,
              options: ['Arbeitsblatt', 'Folien', 'Checkliste', 'Handout'],
              placeholder: 'Bitte waehlen...',
              helpText: 'Welcher Materialtyp soll erstellt werden?',
            },
            {
              id: 'thema',
              label: 'Thema',
              type: 'text',
              required: true,
              placeholder: 'z. B. Bruchrechnung - Addieren und Subtrahieren',
              helpText: 'Welches Thema soll inhaltlich abgedeckt werden?',
            },
            {
              id: 'loesungsblatt',
              label: 'Loesungsblatt mitliefern',
              type: 'checkbox',
              helpText: 'Aktivieren, wenn eine Musterloesung erzeugt werden soll.',
            },
          ],
        }),
        'Einstiegs- und Abschlussphasen': defineTemplate({
          ...
          description: 'Entwirft wirksame Einstiegs- oder Abschlussphasen mit Aktivierung und Reflexion.',
          profile: 'unterrichtsnah',
          requiredBaseFields: ['fach', 'schulstufe', 'ziel'],
          optionalBaseFields: ['zeitrahmen', 'niveau', 'ton', 'ergebnisformat'],
          ...
          dynamicFields: [
            {
              ...
              type: 'select',
              required: true,
              options: ['Einstieg', 'Abschluss'],
              placeholder: 'Bitte waehlen...',
              helpText: 'Soll ein Einstieg oder ein Abschluss gestaltet werden?',
            },
            {
              id: 'impuls',
              label: 'Impuls/Ankerfrage',
              type: 'text',
              required: true,
              placeholder: 'z. B. Leitfrage, Problem, Bildimpuls',
              helpText: 'Was startet bzw. buendelt die Stunde didaktisch wirksam?',
            },
            {
              id: 'reflexionsfragen',
              label: 'Reflexionsfragen',
              type: 'textarea',
              placeholder: 'Optional: 2-4 Leitfragen fuer Reflexion oder Ausblick',
              helpText: 'Optional: Fragen, die Verstehen, Transfer oder Rueckblick anregen.',
            },
          ],
        }),
      },
